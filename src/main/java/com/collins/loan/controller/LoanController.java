...
//    }
    ...
    public Mono<LoanModel> updateLoan(@PathVariable long id, @RequestBody LoanModel loan)throws Exception {
    ...
    @GetMapping("view/{id}")
    public Mono<LoanModel> viewLoan(@PathVariable long id) {
